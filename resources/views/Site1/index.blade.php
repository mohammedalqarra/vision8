...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">{{ $desc }}</p>
        </div>
    </header>
    <!-- Portfolio Section-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto">
                    <p class="lead">{{ $about_f }}</p>
                </div>
                <div class="col-lg-4 me-auto">
                    <p class="lead">{{ $about_l }}</p>
                </div>
            </div>
            <!-- About Section Button-->
            <div class="text-center mt-4">
                <a class="btn btn-xl btn-outline-light" href="{{ $file }}">
    ...
    <section id="table" class="table">
        <div class="container">
            <table class="table my-5 table table-bordered table-hover">
                <tr class="table-dark">
                    <th>Name</th>
                    <th>Email</th>
                    <th>Phone</th>
                ...
                @foreach ($data as $item)
                    <tr @if ($loop->even) class="table-info" @endif>
                        <td>{{ $item['0'] }}</td>
                        <td>{{ $item['1'] }}</td>
                        <td>{{ $item['2'] }}</td>
                    </tr>
